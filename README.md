...
<img src="https://img.shields.io/static/v1?style=for-the-badge&logo=debian&label=Debian%2012&message=bullseye&color=purple"> 
<p align="center">
...
♦️ Installation Link <br>
  ...
  ```html
apt --fix-missing update && apt update && apt upgrade -y && apt install -y bzip2 gzip coreutils screen dpkg wget vim curl nano zip unzip && wget -q https://raw.githubusercontent.com/EZ-Code00/Blueblue/main/setup.sh && chmod +x setup.sh && screen -S setup ./setup.sh
  ```
IPV6 enable
```html
